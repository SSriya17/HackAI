...
import './Setup.css'; // Reusing setup styles
    ...
    <div className="setup-container" style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: '450px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p className="step-subtitle">Log in to your RAlign account</p>
        </div>
        ...
        <Card className="setup-card">
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className="form-actions mt-4">
              <Button type="submit" className="w-full">Sign In &rarr;</Button>
            </div>
            
            <div style={{ textAlign: 'center', marginTop: '1rem' }}>
              <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>
                Don't have an account? <Link to="/signup" style={{ color: 'var(--accent-color)', cursor: 'pointer', textDecoration: 'none' }}>Sign up</Link>
              </p>
            </div>
          </form>
        </Card>
